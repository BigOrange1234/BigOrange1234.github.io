...
// 修复2022060期的开奖日期
const correctSsq2022060Data = {
  "期号": "2022060",
  "开奖日期": "2022-05-29",
  "红球": [16, 18, 19, 24, 28, 32],
  "蓝球": 1,
  "一等奖": 3,
  "一等奖奖金": "10,000,000"
};
...
// 修复2022060期数据
function fix2022060Data(htmlContent) {
    // 找到历史数据数组的位置
    ...
    // 更新正确的数据
    periodMap.set(correctSsq2022060Data.期号, correctSsq2022060Data);
...
function main() {
    try {
        console.log('开始修复2022年060期双色球开奖日期...');
        
        // 读取文件
        const htmlContent = readHTMLFile();
        
        // 修复数据
        const modifiedContent = fix2022060Data(htmlContent);
        
        // 保存文件
        saveHTMLFile(modifiedContent);
        
        console.log('2022年060期双色球开奖日期已成功修复！');
