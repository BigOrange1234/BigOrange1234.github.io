...
// 修复2022061期数据
function fix2022061Data(htmlContent) {
    // 找到历史数据数组的位置
    ...
    // 更新正确的数据
    periodMap.set(correctSsq2022061Data.期号, correctSsq2022061Data);
...
function main() {
    try {
        console.log('开始修复2022年061期双色球开奖日期...');
        
        // 读取文件
        const htmlContent = readHTMLFile();
        
        // 修复数据
        const modifiedContent = fix2022061Data(htmlContent);
        
        // 保存文件
        saveHTMLFile(modifiedContent);
        
        console.log('2022年061期双色球开奖日期已成功修复！');
